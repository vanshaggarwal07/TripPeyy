...
<div align="center">
  <img src="https://skillicons.dev/icons?i=react,typescript,vite,tailwind,nodejs,git,github" alt="Tech Stack" />
</div>

- **Frontend**: React 18, TypeScript
- **Styling**: Tailwind CSS, shadcn/ui
- **Build Tool**: Vite
- **Maps**: [Your Maps API of Choice]
...
1. **Clone the repository**
   ```bash
   git clone https://github.com/vanshaggarwal07/trippeyy.git
   cd trippeyy
   ```
